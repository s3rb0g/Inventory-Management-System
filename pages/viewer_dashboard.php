         ...
         <div class="row">
            <div class="col-xl-3 col-md-6 mb-3">
               <div class="card bg-white border-left-info shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="viewer_company.php" class="text-info font-weight-bold text-decoration-none">
                        View details
                     </a>
                     <a href="viewer_company.php">
            ...
            <div class="col-xl-3 col-md-6 mb-3">
               <div class="card bg-white border-left-warning shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="viewer_item.php" class="text-warning font-weight-bold text-decoration-none">
                        View details
                     </a>
                     <a href="viewer_item.php">
            ...
            <div class="col-xl-3 col-md-6 mb-3">
               <div class="card bg-white border-left-success shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="viewer_material.php" class="text-success font-weight-bold text-decoration-none">
                        View details
                     </a>
                     <a href="viewer_material.php">
            ...
            <div class="col-xl-3 col-md-6 mb-3">
               <div class="card bg-white border-left-primary shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="viewer_service.php" class="text-primary font-weight-bold text-decoration-none">
                        View details
                     </a>
                     <a href="viewer_service.php">
