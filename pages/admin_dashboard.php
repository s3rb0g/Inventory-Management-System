         ...
         <div class="row">
               ...
               <div class="card bg-white border-left-primary shadow h-100">
                  <div class="card-body text-primary d-flex align-items-center py-2">
                     ...
                     <div class="ml-auto text-right">
                        <div class="h1 mb-0 font-weight-bold"><?php echo $total_accounts ?></div>
                        <div class="text-sm">Accounts</div>
                     </div>
                  </div>
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="admin_account.php" class="text-primary font-weight-bold text-decoration-none">
                        View details
                     </a>
            ...
            <div class="col-xl-4 col-md-6 mb-3">
               <div class="card bg-white border-left-info shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="admin_company.php" class="text-info font-weight-bold text-decoration-none">
                        View details
                     </a>
            ...
            <div class="col-xl-4 col-md-6 mb-3">
               <div class="card bg-white border-left-warning shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="admin_item.php" class="text-warning font-weight-bold text-decoration-none">
                        View details
                     </a>
         ...
         <div class="row">
            <div class="col-xl-6 col-md-6 mb-3">
               <div class="card bg-white border-left-success shadow h-100">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="admin_material.php" class="text-success font-weight-bold text-decoration-none">
                        View details
                     </a>
                     <a href="admin_material.php">
            ...
            <div class="col-xl-6 col-md-6 mb-3">
               <div class="card bg-white border-left-danger shadow h-100">
                  <div class="card-body text-danger d-flex align-items-center py-2">
                     <div class="mr-3 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                     <a href="admin_service.php" class="text-danger font-weight-bold text-decoration-none">
                        View details
                     </a>
